		...
		tweecool : function(options) {
			...
			function xTimeAgo(time) {
				...
				if (timeDiff > second && timeDiff < minute) {
					return Math.round(timeDiff / second) + " seconds ago on Twitter";
				} else if (timeDiff >= minute && timeDiff < hour) {
					return Math.round(timeDiff / minute) + " minutes ago on Twitter";
				} else if (timeDiff >= hour && timeDiff < day) {
					return Math.round(timeDiff / hour) + " hours ago on Twitter";
				} else if (timeDiff >= day && timeDiff < week) {
					return Math.round(timeDiff / day) + " days ago on Twitter";
				} else if (timeDiff >= week && timeDiff < month) {
					return Math.round(timeDiff / week) + " weeks ago on Twitter";
				} else if (timeDiff >= month && timeDiff < year) {
					return Math.round(timeDiff / month) + " months ago on Twitter";
				} else {
					return 'over a year ago on Twitter';
				}
